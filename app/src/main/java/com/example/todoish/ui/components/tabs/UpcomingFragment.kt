...
import com.example.todoish.databinding.FragmentUpcomingBinding
...
class UpcomingFragment : Fragment() {
    ...
    private lateinit var viewDataBinding: FragmentUpcomingBinding
    ...
    override fun onCreateView(
        ...
        viewDataBinding = FragmentUpcomingBinding.inflate(inflater, container, false).apply {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            ...
            viewModel.fetchUpcomingTodo(viewModel.today.value)

            // this will run when data changes
